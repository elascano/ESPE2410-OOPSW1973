package ec.edu.espe.contactbooks.model;
import ec.edu.espe.contactbooks.view;
...
public class Contact {
    ...
    public String toString() {
        return "Contact{"  \n\+"id=" + id + ", name=" + name + ", birthDate="
                + birthDate + ", email=" + email + ", numberOfMutualFriends="
                + numberOfMutualFriends + ", numberOfOtherFriends="
