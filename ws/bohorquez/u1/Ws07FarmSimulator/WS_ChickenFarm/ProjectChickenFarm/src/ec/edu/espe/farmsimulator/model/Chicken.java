...
public class Chicken {
    ...
    public Chicken(int id, String name, String color, int age, Date bornOnDate, boolean notMolting) {
        this.id = id;
        this.name = name;
        this.color = color;
        ...
        //TODO call de function that implements the algorith to calcule ageInMonths
    ...
    public int computeAgeInMonths(){
        //TODO computer ageInMonths in months
