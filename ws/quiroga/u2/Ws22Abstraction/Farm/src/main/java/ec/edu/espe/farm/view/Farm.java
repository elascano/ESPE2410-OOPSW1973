...
public class Farm {
    public static void main(String[] args) {
        ...
        System.out.println("Now, farmAnimal is --> "+ farmAnimal.getClass().getCanonicalName());
