...
vaccineId = 2;
mammal.feed(new Food(1, 5.2, "mouse"));
mammal.breastFeed();
mammal.register();
mammal.provideVaccination(new Vaccine(vaccineId, "Ibuprophene"));
mammal.assignCage(cage);

ZooPrinter.printAnimalDetails(mammal, cage);

let bird = new Bird(1.5, true, 2, "Eagle", new Date(2023, 3, 15), 3.1, 'M', [new Vaccine(3, "Bird Flu Vaccine")]);
bird.chirp();
bird.migrate("Northern Europe");
bird.provideVaccination(new Vaccine(4, "Avian Vaccination"));
...
amphibian.provideVaccination(new Vaccine(8, "Skin Protection"));
