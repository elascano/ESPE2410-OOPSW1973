...
def buscar_teclado():
    ...
    def mostrar_datos(teclado):
        ...
        datos_ventana.geometry("300x200")
        datos_ventana.resizable(False, False)

        Label(datos_ventana, text="ID: " + str(teclado["id"]), font=("Segoe UI", 12)).pack(pady=5)
        Label(datos_ventana, text="Marca: " + teclado["marca"], font=("Segoe UI", 12)).pack(pady=5)
        Label(datos_ventana, text="Tipo: " + teclado["tipo"], font=("Segoe UI", 12)).pack(pady=5)
        Label(datos_ventana, text="Precio: " + str(teclado["precio"]), font=("Segoe UI", 12)).pack(pady=5)
...
Button(DtaFrame, text="Buscar", width=10).grid(row=4, column=2, padx=10)
