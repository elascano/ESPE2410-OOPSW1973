...
public class FrmContactBook extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        favoriteSports.add(cbSports.getSelectedItem().toString());
    }//GEN-LAST:event_btnAddActionPerformed

    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        Contact contact = ContactController.find(txtID.getText());
        if (contact != null) {
            txtID.setText(String.valueOf(contact.getId()));
            txtName.setText(contact.getName());
            cbSex.setSelectedItem(String.valueOf(contact.getSex()));
            cbGender.setSelectedItem(contact.getGender());
            cbMarital.setSelectedItem(contact.getMaritalStatus());
            cbSports.setSelectedItem(contact.getFavoriteSports().get(0));
            txtComment.setText(contact.getComments());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (JOptionPane.showConfirmDialog(rootPane, "¿Está seguro de eliminar este contacto?", 
        "Confirmar eliminación", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
        if (ContactController.delete(txtID.getText())) {
            clearForm();
    ...
    private void clearForm() {
        ...
        cbSports.setSelectedItem("Basketball");
        txtComment.setText("");
