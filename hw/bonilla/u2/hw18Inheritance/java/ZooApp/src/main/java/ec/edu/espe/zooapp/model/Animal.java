...
public class Animal {
    ...
    public void register(){
        System.out.println("registeering the animal --> " + this.name);
    }
    
    public void assignCage (Cage cage){
        //TODO assign this animal to a cage
        System.out.println("Assigning an animal -- >"+this.name  +"in cage -->"+cage);
        cage.getAnimals().add(this);
    }
    
    public void provideVaccination(Vaccine vaccine){
        System.out.println(" providing vaccine --> 0"+vaccine+"<-- to "+this.name);
