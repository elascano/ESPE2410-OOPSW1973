...
public class FrmContact extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        dateOfBirth.set(Calendar.MONTH, 06);
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        // Buscar contacto en MongoDB por ID
        Contact contact = MongoDBManager.find(txtid.getText(), Contact.class);
        if (contact == null) {
            ...
            cmbSex.setSelectedItem(contact.getSex() == 'm' ? "male" : "female");
    ...
    private void btnDeteleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeteleActionPerformed
        // Eliminar contacto en MongoDB
        if (JOptionPane.showConfirmDialog(rootPane, "Are you sure") == JOptionPane.YES_OPTION) {
            Contact contactToDelete = new Contact(Integer.parseInt(txtid.getText()), "", ' ', "", "", null, null, "");
            if (MongoDBManager.delete(contactToDelete)) {
