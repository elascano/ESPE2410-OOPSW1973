...
import ec.edu.espe.mole.exeption.ProjectException;
...
public class ProjectController {
    ...
    public void listProjects() {
        ...
        List<Project> projectlist= new ArrayList<>();
        String filepath="data/project.json";
        Type projectListType=new TypeToken<List<Project>>() {}.getType();
    ...
    public void updateProjectStatus(String projectId, Status newStatus) throws ProjectException {
    ...
    if (!projectFound) {
        throw new ProjectException("Project with ID " + projectId + " not found.");
    }
}
